...
public class UserQuery {
	...
	public String cb_hotels = "SELECT * FROM hotels WHERE deleted_at IS NULL";
	...
	public String count = "SELECT COUNT(id) AS passenger_count FROM passenger WHERE bookings_id = ?";
